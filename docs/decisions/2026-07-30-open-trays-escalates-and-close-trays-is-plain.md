...
Superseded by: `2026-08-29-bulk-tray-moves-are-serial-and-close-is-blocked-during-a-rip.md` (parallel execution and close-during-rip clauses only); `2026-09-08-open-trays-skips-active-rips-until-only-they-remain.md` (open scope and active-bay reporting clauses only)
